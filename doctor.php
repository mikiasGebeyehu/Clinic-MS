...
if (isset($_POST['login'])) {
    ...
    if (empty($uname)) {
        ...
        $stmt = $conn->prepare("SELECT * FROM doctors WHERE uname = ? AND password = ?");
        ...
        if ($row) {
            if ($row['status'] == "Pending") {
                ...
                $error['login'] = "your request is rejected by the adminsters";
            } else {
                echo "<script>alert('You can successfully login')</script>";
                $_SESSION['doctor'] = $uname;
                header('Location: doctor/index.php'); // Redirect to the dashboard or appropriate page
                exit;
            }
        } else {
...
<body>
<form class="mx-auto" action="doctor.php" method="post">
    ...
    <p>I don't have an account: <a href="sign-ind.php">Sign Up!!!</a></p>
</form>
