...
$query = "SELECT id, uname, email, phonenumber FROM doctors WHERE status='pending'";
...
if (mysqli_num_rows($result) < 1) {
    $output .= "
        <tr>
            <td colspan='5' class='text-center text-danger font-weight-bold'>NO DOCTOR REQUESTED TO THE ADMINISTRATOR</td>
        </tr>
    ";
} else {
...
$output .= "
        ...
        <div class='card-footer text-center'>
            <small>Manage pending doctor requests</small>
        </div>
    </div>
</div>
";
